...
import pheonix_proj from "../assets/phoenix-project.jpg";

function BlogCard(blogCardTitle, monDayYear, blogDesc, blogImg = null) {
...
const card6 = new BlogCard(
    "The Phoenix Project",
    ["January", "6", "2025"],
    "As a software engineer not usually involved in IT operations, I found The Phoenix Project fascinating. My wife works in manufacturing, so seeing the parallels between manufacturing processes and software delivery was eye-opening. The book gave me a new appreciation for how concepts like WIP, bottlenecks, and continuous improvement apply to both fields. Highly recommended for anyone interested in how IT and business can work together more effectively.",
    pheonix_proj
);
...
const card4 = new BlogCard(
    ...
    "While I am on parental leave (in-between bottle feedings and diaper changes) I decided to watch AMC's new " +
        ...
        "to season 3! This show has inspired me to read more books in Rice's Vampire Chronicles.",
    interview_img
);
