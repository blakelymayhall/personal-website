...
const boeingTest4 = new ExpCard("Product Ownership", [
    "Served as Flight Systems Lean Champion, presenting process improvements like enhanced pitch control LQR algorithm",
    "Established distributed system simulation in C++ to simulate" + " autonomously controlled direct attack missions",
...
const boeingTest5 = new ExpCard("System Modeling", [
    "Developed and validated camera-seeker models for closed-loop simulations, focusing on detection, acquisition, and multi-target tracking algorithms",
...
const ulCard3 = new ExpCard("Process Engineering", ["Assisted with the development of SOPs to test products"]);
