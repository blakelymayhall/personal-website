...
let boeingData = [];
const boeingTest1 = new ExpCard("Test Skill 1", [
    "Exp Test1",
    "Exp Test2mExp Test2mExp Test2mExp Test2mExp Test2mExp Test2",
    "Exp Test3",
]);
const boeingTest2 = new ExpCard("Test Skill 2", ["Exp Test1", "Exp Test2", "Exp Test3"]);
const boeingTest3 = new ExpCard("Test Skill 3", ["Exp Test1", "Exp Test2", "Exp Test3"]);
...
let aglData = [];
const aglTest1 = new ExpCard("Test Skill 1", ["Exp Test1", "Exp Test2", "Exp Test3"]);
const aglTest2 = new ExpCard("Test Skill 2", ["Exp Test1", "Exp Test2", "Exp Test3"]);
const aglTest3 = new ExpCard("Test Skill 3", ["Exp Test1", "Exp Test2", "Exp Test3"]);
